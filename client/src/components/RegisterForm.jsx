        ...
        <div class="glass-container">
            ...
            <form id="login_form" action="" method=""> 
                <div class="input-text">
                    ...
                    <input type="password" id="confirmation" name="confirmation" placeholder="Confirm password" value={confirmation} onChange={(e) => setConfirmation(e.target.value)} required/> <br/>
                </div>
                <button class="btn" type="submit" onClick={handleRegister}>Sign Up</button>
                {message && <p>{message}</p>}
                <div><p>Already have an account? <Link to="/LoginForm">&nbsp;&nbsp;Login</Link></p></div>
            </form>
        </div>
    )
}
